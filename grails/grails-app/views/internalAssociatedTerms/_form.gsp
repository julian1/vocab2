...
<div class="fieldcontain ${hasErrors(bean: internalAssociatedTermsInstance, field: 'associationType', 'error')} required">
	...
	<g:select id="associationType" name="associationType.id" from="${vocab.AssociationType.list()}" optionKey="id" required="" value="${internalAssociatedTermsInstance?.associationType?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: internalAssociatedTermsInstance, field: 'objectVocabularyTerm', 'error')} required">
	...
	<g:select id="objectVocabularyTerm" name="objectVocabularyTerm.id" from="${vocab.VocabularyTerm.list()}" optionKey="id" required="" value="${internalAssociatedTermsInstance?.objectVocabularyTerm?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: internalAssociatedTermsInstance, field: 'subjectVocabularyTerm', 'error')} required">
	...
	<g:select id="subjectVocabularyTerm" name="subjectVocabularyTerm.id" from="${vocab.VocabularyTerm.list()}" optionKey="id" required="" value="${internalAssociatedTermsInstance?.subjectVocabularyTerm?.id}" class="many-to-one"/>
