...
<div class="fieldcontain ${hasErrors(bean: externalAssociatedTermsInstance, field: 'associationType', 'error')} required">
	...
	<g:select id="associationType" name="associationType.id" from="${vocab.AssociationType.list()}" optionKey="id" required="" value="${externalAssociatedTermsInstance?.associationType?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: externalAssociatedTermsInstance, field: 'vocabularyTerm', 'error')} required">
	...
	<g:select id="vocabularyTerm" name="vocabularyTerm.id" from="${vocab.VocabularyTerm.list()}" optionKey="id" required="" value="${externalAssociatedTermsInstance?.vocabularyTerm?.id}" class="many-to-one"/>
