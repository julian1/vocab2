...
<div class="fieldcontain ${hasErrors(bean: termCategoryClassificationInstance, field: 'classificationSchemeCategory', 'error')} required">
	...
	<g:select id="classificationSchemeCategory" name="classificationSchemeCategory.id" from="${vocab.ClassificationSchemeCategory.list()}" optionKey="id" required="" value="${termCategoryClassificationInstance?.classificationSchemeCategory?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: termCategoryClassificationInstance, field: 'vocabularyTerm', 'error')} required">
	...
	<g:select id="vocabularyTerm" name="vocabularyTerm.id" from="${vocab.VocabularyTerm.list()}" optionKey="id" required="" value="${termCategoryClassificationInstance?.vocabularyTerm?.id}" class="many-to-one"/>
