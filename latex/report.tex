...
content. However there is no direct support for searching such content using SISSVoc
URIs patterns. A sparql interface would however provide a query mechanism for non-SKOS
