...
% \includegraphics[width=7cm]{multipleendpoints}  
% \caption{A figure}
% \floatfoot{A note}
% \end{figure}
...
schemes. SISSVoc can also traverse via hyperlinks for associated terms. 
%
\includegraphics[width=12cm]{sissvoc}  
\footnote{ SISSVoc links to multiple vocabularies } 
% need a footnote.
%
