...
mechanism to access RDF providing a strong separation of concerns.
  ...
  It would be possible to map the already IMOS developed \texttt{control\_vocab\_db} to expose a sparql
interface using a tool such as r2d  \footnote{ \url{ http://www.w3.org/TR/r2rml/ } }  .  The sparql interface would the provide the
