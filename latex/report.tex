...
apply to registrars, not SKOS content maintained by particular registrars.  
...
separation of concerns. It would be feasible to map the already IMOS developed
...
performed in one controlled vocabulary system. The SPARQL interface
