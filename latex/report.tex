...
%
\item Alternatively, normal url de-referencing allows navigation to non-SISSVoc
vocabulary implementations (eg. BODC/NERC) based around normal RDF resource uris.
%
...
\begin{figure}[H]
\centering
\caption{SISSVoc host demonstrating access to multiple SISSVoc domains}
