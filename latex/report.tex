...
\item[] It's not evident that centralised registration management such as that provided by LDP necessarily matches IMOS/EMII organisational publishing requirements. Even LDP authors acknowledge their project is somewhat contrary to the non-federated nature of RDF
...
\item[] A non-insubstantial investment has been made around control vocab publishing database. This includes supporting the appending of geoserver paramter and unit information at download and 
as a source of SKOS vocabulary for Geonetwork/Portal. Abandoning this effort would require establishing new work-flows
\item[] Some options are currently unfunded, and lack project oversight, technical support, points of contact etc.
...
\section{
  ...
  Trying to understand the nature and scope of LDP was complicated by the absence of any production hosts. and where avilable documentation 
